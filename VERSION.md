...
|-----------|--------|-------|
| Mobile APK | 1.4.6+17 | все `cursor/*`, `main`, `develop` |
...
Все рабочие ветки синхронизированы на **v1.4.6** (Coach A + Profile A + Analytics A).
...
- Исправлен чёрный экран после подключения весов
